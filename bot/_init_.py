...
try:
    ...
    STATUS_LIMIT = None
try:
    K2S_ACCESS_TOKEN = getConfig('K2S_ACCESS_TOKEN')
    if len(K2S_ACCESS_TOKEN) == 0:
        raise KeyError
except:
    K2S_ACCESS_TOKEN = None
try:
    K2S_REFRESH_TOKEN = getConfig('K2S_REFRESH_TOKEN')
    if len(K2S_REFRESH_TOKEN) == 0:
        raise KeyError
except:
    K2S_REFRESH_TOKEN = None
try:
